...
export class BuildService {
     ...
     * @param timeOutSeconds - Maximum waiting time for build to complete, default 1800s.
     */
    waitForBuild(appId: string, packageId: string, timeOutSeconds = 1800): Promise<Package> {
